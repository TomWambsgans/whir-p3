    ...
    EF: ExtensionField<F> + TwoAdicField,
{
    ...
    pub(crate) commitment_merkle_prover_data:
        Arc<RoundMerkleTree<F::PrimeSubfield, F, F::PrimeSubfield, DIGEST_ELEMS>>,
    ...
    pub(crate) merkle_prover_data:
        Option<RoundMerkleTree<F::PrimeSubfield, EF, F::PrimeSubfield, DIGEST_ELEMS>>,
    ...
    <F as PrimeCharacteristicRing>::PrimeSubfield: TwoAdicField,
{
    ...
    where
        Challenger:
            FieldChallenger<F::PrimeSubfield> + GrindingChallenger<Witness = F::PrimeSubfield>,
    {
